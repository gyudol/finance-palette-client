...
public class Loan1_detail_screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intentGet != null) {
            ...
            if (receivedOptNum != null) {
                ...
                getData("http://" + ipv4Address + "/PHP_loan1_int.php", optNum);
            }
        }
        ...
        star.setOnClickListener(new View.OnClickListener() {   // 북마크 이미지 뷰 클릭하면 북마크 기능
            ...
            public void onClick(View v) {
                ...
                bs.setData("http://" + ipv4Address + "/PHP_bookmark_upd.php", 4, optNum, "", as.aaid);
            }
        });

        ///////////////////////////////// 조회 기록
        viewHistoryState vs = new viewHistoryState(this);
        vs.getData("http://" + ipv4Address, fin_prdt_num_cd, as.aaid, 4, optNum, "");
