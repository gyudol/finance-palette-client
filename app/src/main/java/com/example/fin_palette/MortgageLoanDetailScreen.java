...
public class MortgageLoanDetailScreen extends AppCompatActivity {
    ...
    private static final String TAG_MORTGAGE_TYPE = "mortgage_type";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mortgage_loan_detail_screen);
        ...
        if (intentGet != null) {
            ...
            if (receivedOptionId != null) {
                ...
                getData(apiEndpoint + "/mortgage_loan_int.php", optionId);
            }
        }

        //////////////////////// 북마크 /////////////////////////////////
        ImageView star = findViewById(R.id.bookmark);
        bookmarkId = historyId = 5 + "_" + optionId + '_';
        ...
        star.setOnClickListener(new View.OnClickListener() {   // 북마크 이미지 뷰 클릭하면 북마크 기능
            ...
            public void onClick(View v) {
                ...
                bs.setData(apiEndpoint + "/bookmark_upd.php", 5, optionId, "", am.aaid);
            }
        });
    ...
    protected void showWindow() {
        try {
            ...
            TextView mrtgTypeTextView = findViewById(R.id.mrtg_type);
            ...
            mrtgTypeTextView.setText(nullToSpace(c.getString(TAG_MORTGAGE_TYPE)));
